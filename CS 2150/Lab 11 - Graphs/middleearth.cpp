...
/** @brief Constructor for all of middle earth
 * Creates middle earth based in a given size with specified number of cities. 
 * Randomly generates based on size.
 * Creates array of distances and map of cities
 * @param xsize dimension x of middle earth
 * @param ysize dimension y of middle earth
 * @param num_cities number of cities in middle earth
 * @param seed 
 * @warning Beware Sauron
 * 
 */
...
/** @brief prints all of distances of middle earth
 * 
 * 
 * 
 */
...
/** @brief Returns distance between two specific cities
...
/** @brief returns travelling agenda for middle earth
