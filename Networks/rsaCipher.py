# RSA Cipher
# http://inventwithpython.com/hacking (BSD Licensed) dlf4mf
...
def main():
    # Encrypts a message to a file or decrypts a message
    # from a file.
    filename = 'message_from_ai4z.txt' # the file to write to/read from
    mode = 'decrypt' # set to 'encrypt' or 'decrypt'

    if mode == 'encrypt':
        message = "Alf Weaver is the true harambe"
        key = 'dlf4mf_pubkey.txt'
        print('Encrypting and writing to %s...' % (filename))
        encryptedText = encryptAndWriteToFile(filename, key, message)
