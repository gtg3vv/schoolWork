...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_srcA = ((((((_HCL_D_icode)==(6)))||(((_HCL_D_icode)==(2))))||(((_HCL_D_icode)==(4)))) ? (_HCL_D_rA) :
		(15));
    _HCL_reg_srcA &= 0xf;
    ...
    ulong _HCL_reg_inputE = (((((((_HCL_W_icode)==(3)))||(((_HCL_W_icode)==(6))))||(((_HCL_W_icode)==(2))))||(((_HCL_W_icode)==(5)))) ? (_HCL_W_ValE) :
		0);
    ...
    ulong _HCL_loadUse = ((((_HCL_reg_srcA)==(_HCL_E_dstM))||((_HCL_reg_srcB)==(_HCL_E_dstM))))&&((_HCL_E_icode)==(5));
    _HCL_loadUse &= 0x1;
    ...
    ulong _HCL_mem_addr = (((((_HCL_M_icode)==(11)))||(((_HCL_M_icode)==(9)))) ? (_HCL_reg_outputB) :
		(_HCL_M_ValE));
    _HCL_mem_addr &= 0xffffffffffffffff;
    if (showall) writefln("set mem_addr to 0x%x",_HCL_mem_addr);
    ulong _HCL_mem_input = (((_HCL_M_icode)==(8)) ? (_HCL_valP) :
		(_HCL_M_ValA));
...
pragma(msg,`Estimated clock delay: 81`);
enum tpt = 81;
...
int main(string[] args) {
	...
	write(`| register dE(`,(_HCL_bubble_E?'B':_HCL_stall_E?'S':'N'));
		...
		writefln(`|  ValC=%016x dstE=%01x dstM=%01x icode=%01x ifun=%01x }                 |`, _HCL_E_ValC, _HCL_E_dstE, _HCL_E_dstM, _HCL_E_icode, _HCL_E_ifun);
	...
	write(`| register eM(`,(_HCL_bubble_M?'B':_HCL_stall_M?'S':'N'));
		...
		writefln(`|  conditionsMet=%01x dstE=%01x dstM=%01x icode=%01x }                              |`, _HCL_M_conditionsMet, _HCL_M_dstE, _HCL_M_dstM, _HCL_M_icode);
