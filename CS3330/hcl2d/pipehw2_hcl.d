...
int tick(bool showpc=true, bool showall=false) {
    ulong _HCL_pc = (((_HCL_W_icode)==(9)) ? (_HCL_W_ValM) :
		(((_HCL_M_icode)==(7))&&(!_HCL_M_conditionsMet)) ? (_HCL_M_ValP) :
		(_HCL_F_predPC));
    ...
    ulong _HCL_reg_srcA = (((((((_HCL_D_icode)==(6)))||(((_HCL_D_icode)==(2))))||(((_HCL_D_icode)==(4))))||(((_HCL_D_icode)==(10)))) ? (_HCL_D_rA) :
    ...
    ulong _HCL_reg_srcB = (((((((_HCL_D_icode)==(11)))||(((_HCL_D_icode)==(10))))||(((_HCL_D_icode)==(8))))||(((_HCL_D_icode)==(9)))) ? (4) :
		(((((_HCL_D_icode)==(6)))||(((_HCL_D_icode)==(4))))||(((_HCL_D_icode)==(5)))) ? (_HCL_D_rB) :
		(15));
    _HCL_reg_srcB &= 0xf;
    ...
    ulong _HCL_mem_addr = (((((_HCL_M_icode)==(11)))||(((_HCL_M_icode)==(9)))) ? (_HCL_M_ValA) :
		(_HCL_M_ValE));
    ...
    ulong _HCL_mem_writebit = ((((((_HCL_M_icode)==(4)))||(((_HCL_M_icode)==(10))))||(((_HCL_M_icode)==(8)))) ? (1UL) :
		(0UL));
    _HCL_mem_writebit &= 0x1;
    if (showall) writefln("set mem_writebit to 0x%x",_HCL_mem_writebit);
    ulong _HCL_mem_readbit = ((((((_HCL_M_icode)==(5)))||(((_HCL_M_icode)==(11))))||(((_HCL_M_icode)==(9)))) ? (1UL) :
		(0UL));
    _HCL_mem_readbit &= 0x1;
    if (showall) writefln("set mem_readbit to 0x%x",_HCL_mem_readbit);
    ulong _HCL_reg_dstE = ((((((((((_HCL_W_icode)==(2)))||(((_HCL_W_icode)==(3))))||(((_HCL_W_icode)==(6))))||(((_HCL_W_icode)==(10))))||(((_HCL_W_icode)==(11))))||(((_HCL_W_icode)==(8))))||(((_HCL_W_icode)==(9)))) ? (_HCL_W_dstE) :
		(15));
    _HCL_reg_dstE &= 0xf;
    ...
    ulong _HCL_reg_inputE = (((((((((((_HCL_W_icode)==(3)))||(((_HCL_W_icode)==(6))))||(((_HCL_W_icode)==(2))))||(((_HCL_W_icode)==(5))))||(((_HCL_W_icode)==(10))))||(((_HCL_W_icode)==(11))))||(((_HCL_W_icode)==(8))))||(((_HCL_W_icode)==(9)))) ? (_HCL_W_ValE) :
		0);
    ...
    ulong _HCL_offset = ((((((_HCL_f_icode)==(0)))||(((_HCL_f_icode)==(1))))||(((_HCL_f_icode)==(9)))) ? (1UL) :
		...
		((((_HCL_f_icode)==(8)))||(((_HCL_f_icode)==(7)))) ? (9UL) :
		(10UL));
    ...
    ulong _HCL_loadUse = ((((_HCL_reg_srcA)==(_HCL_e_dstM))||((_HCL_reg_srcB)==(_HCL_e_dstM))))&&(((((_HCL_e_icode)==(5)))||(((_HCL_e_icode)==(11)))));
    _HCL_loadUse &= 0x1;
    if (showall) writefln("set loadUse to 0x%x",_HCL_loadUse);
    _HCL_stall_F = cast(bool)(((((_HCL_loadUse)||((_HCL_f_Stat)!=(1)))||(((_HCL_D_icode)==(9))))||(((_HCL_f_icode)==(9))))||(((_HCL_E_icode)==(9))));
    ...
    _HCL_bubble_E = cast(bool)((_HCL_loadUse)||(((((_HCL_e_icode)==(7)))&&((!_HCL_e_conditionsMet)))));
    if (showall) writefln("set bubble_E to %s",_HCL_bubble_E);
    _HCL_bubble_D = cast(bool)(((((_HCL_e_icode)==(7))&&(!_HCL_e_conditionsMet)))||((((((((_HCL_D_icode)==(9)))||(((_HCL_M_icode)==(9))))||(((_HCL_E_icode)==(9)))))&&(!_HCL_loadUse))));
    ...
    ulong _HCL_d_ValA = ((((_HCL_e_dstE)!=(15))&&((_HCL_e_dstE)==(_HCL_reg_srcA))) ? (_HCL_e_ValE) :
		(((_HCL_reg_srcA)!=(15))&&((_HCL_reg_srcA)==(_HCL_M_dstM))) ? (_HCL_m_ValM) :
		(((_HCL_M_dstE)!=(15))&&((_HCL_M_dstE)==(_HCL_reg_srcA))) ? (_HCL_M_ValE) :
		(((_HCL_reg_srcA)!=(15))&&((_HCL_reg_srcA)==(_HCL_W_dstM))) ? (_HCL_W_ValM) :
		(((_HCL_W_dstE)!=(15))&&((_HCL_W_dstE)==(_HCL_reg_srcA))) ? (_HCL_W_ValE) :
		(_HCL_reg_outputA));
    _HCL_d_ValA &= 0xffffffffffffffff;
    if (showall) writefln("set d_ValA to 0x%x",_HCL_d_ValA);
    ulong _HCL_d_ValB = ((((_HCL_e_dstE)!=(15))&&((_HCL_e_dstE)==(_HCL_reg_srcB))) ? (_HCL_e_ValE) :
		(((_HCL_reg_srcB)!=(15))&&((_HCL_reg_srcB)==(_HCL_M_dstM))) ? (_HCL_m_ValM) :
		(((_HCL_M_dstE)!=(15))&&((_HCL_M_dstE)==(_HCL_reg_srcB))) ? (_HCL_M_ValE) :
		(((_HCL_reg_srcB)!=(15))&&((_HCL_reg_srcB)==(_HCL_W_dstM))) ? (_HCL_W_ValM) :
		(((_HCL_W_dstE)!=(15))&&((_HCL_W_dstE)==(_HCL_reg_srcB))) ? (_HCL_W_ValE) :
		(_HCL_reg_outputB));
...
pragma(msg,`Estimated clock delay: 65`);
enum tpt = 65;
...
int main(string[] args) {
	...
	write(`| register xF(`,(_HCL_bubble_F?'B':_HCL_stall_F?'S':'N'));
		writefln(`) { predPC=%016x }                            |`, _HCL_F_predPC);


	write(`| register fD(`,(_HCL_bubble_D?'B':_HCL_stall_D?'S':'N'));
		writefln(`) { Stat=%01x ValC=%016x ValP=%016x   |`, _HCL_D_Stat, _HCL_D_ValC, _HCL_D_ValP);
		writefln(`|  icode=%01x ifun=%01x rA=%01x rB=%01x }                                           |`, _HCL_D_icode, _HCL_D_ifun, _HCL_D_rA, _HCL_D_rB);
	...
	write(`| register dE(`,(_HCL_bubble_E?'B':_HCL_stall_E?'S':'N'));
		...
		writefln(`|  ValC=%016x ValP=%016x dstE=%01x dstM=%01x icode=%01x    |`, _HCL_E_ValC, _HCL_E_ValP, _HCL_E_dstE, _HCL_E_dstM, _HCL_E_icode);
		writefln(`|  ifun=%01x }                                                             |`, _HCL_E_ifun);
	...
	write(`| register eM(`,(_HCL_bubble_M?'B':_HCL_stall_M?'S':'N'));
		...
		writefln(`|  ValP=%016x conditionsMet=%01x dstE=%01x dstM=%01x icode=%01x }        |`, _HCL_M_ValP, _HCL_M_conditionsMet, _HCL_M_dstE, _HCL_M_dstM, _HCL_M_icode);


	write(`| register mW(`,(_HCL_bubble_W?'B':_HCL_stall_W?'S':'N'));
		writefln(`) { Stat=%01x ValE=%016x ValM=%016x   |`, _HCL_W_Stat, _HCL_W_ValE, _HCL_W_ValM);
		writefln(`|  dstE=%01x dstM=%01x icode=%01x }                                              |`, _HCL_W_dstE, _HCL_W_dstM, _HCL_W_icode);
