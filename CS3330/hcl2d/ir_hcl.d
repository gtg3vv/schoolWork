...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_valC = cast(ulong)(((_HCL_i10bytes)>>16UL)&0xffffffffffffffff);
    ...
    ulong _HCL_reg_dstE = (((_HCL_icode)==(3)) ? (_HCL_regB) :
		(15));
    _HCL_reg_dstE &= 0xf;
    if (showall) writefln("set reg_dstE to 0x%x",_HCL_reg_dstE);
    ulong _HCL_reg_inputE = _HCL_valC;
    ...
    ulong _HCL_Stat = (((_HCL_icode)==(0)) ? (2) :
		((((_HCL_icode)==(7))||((_HCL_icode)==(8)))||((_HCL_icode)==(9))) ? (4) :
		(1));
    _HCL_Stat &= 0x7;
    ...
    ulong _HCL_p_pc = (((((((_HCL_icode)==(2))||((_HCL_icode)==(6)))||((_HCL_icode)==(2)))||((_HCL_icode)==(10)))||((_HCL_icode)==(11))) ? ((_HCL_P_pc)+(2UL)) :
		...
		(((_HCL_icode)==(7))||((_HCL_icode)==(8))) ? ((_HCL_P_pc)+(9UL)) :
		((_HCL_P_pc)+(1UL)));
...
pragma(msg,`Estimated clock delay: 42`);
enum tpt = 42;
