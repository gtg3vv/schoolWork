...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_valC = (((((_HCL_icode)==(7)))||(((_HCL_icode)==(8)))) ? (cast(ulong)(((_HCL_i10bytes)>>8UL)&0xffffffffffffffff)) :
    ...
    ulong _HCL_reg_srcB = (((((((_HCL_icode)==(11)))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (4) :
		(_HCL_regB));
    _HCL_reg_srcB &= 0xf;
    ...
    ulong _HCL_mem_writebit = ((((((_HCL_icode)==(4)))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(8)))) ? (1UL) :
		(0UL));
    _HCL_mem_writebit &= 0x1;
    if (showall) writefln("set mem_writebit to 0x%x",_HCL_mem_writebit);
    ulong _HCL_mem_readbit = ((((((_HCL_icode)==(5)))||(((_HCL_icode)==(11))))||(((_HCL_icode)==(9)))) ? (1UL) :
		(0UL));
    ...
    ulong _HCL_reg_dstE = (((!_HCL_conditionsMet)&&((_HCL_icode)==(2))) ? (15) :
		...
		((_HCL_icode)==(5)) ? (_HCL_regA) :
		((((((_HCL_icode)==(10)))||(((_HCL_icode)==(11))))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (4) :
		(15));
    _HCL_reg_dstE &= 0xf;
    if (showall) writefln("set reg_dstE to 0x%x",_HCL_reg_dstE);
    ulong _HCL_reg_dstM = ((((_HCL_icode)==(11))) ? (_HCL_reg_srcA) :
		(15));
    _HCL_reg_dstM &= 0xf;
    ...
    ulong _HCL_valP = ((((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? ((_HCL_P_pc)+(2UL)) :
		(((((_HCL_icode)==(3)))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(5)))) ? ((_HCL_P_pc)+(10UL)) :
		((_HCL_icode)==(8)) ? ((_HCL_P_pc)+(9UL)) :
		(((_HCL_icode)==(7))&&(_HCL_conditionsMet)) ? (_HCL_valC) :
		(((_HCL_icode)==(7))&&(!_HCL_conditionsMet)) ? ((_HCL_P_pc)+(9UL)) :
		((_HCL_P_pc)+(1UL)));
    ...
    ulong _HCL_valE = ((((_HCL_icode)==(6))&&((_HCL_ifun)==(0))) ? ((_HCL_reg_outputA)+(_HCL_reg_outputB)) :
		...
		((((_HCL_icode)==(4)))||(((_HCL_icode)==(5)))) ? ((_HCL_reg_outputB)+(_HCL_valC)) :
		((((_HCL_icode)==(10)))||(((_HCL_icode)==(8)))) ? ((_HCL_reg_outputB)-(8UL)) :
		((((_HCL_icode)==(11)))||(((_HCL_icode)==(9)))) ? ((_HCL_reg_outputB)+(8UL)) :
		(0UL));
    ...
    ulong _HCL_mem_addr = (((((_HCL_icode)==(11)))||(((_HCL_icode)==(9)))) ? (_HCL_reg_outputB) :
		(_HCL_valE));
    _HCL_mem_addr &= 0xffffffffffffffff;
    if (showall) writefln("set mem_addr to 0x%x",_HCL_mem_addr);
    ulong _HCL_mem_input = (((_HCL_icode)==(8)) ? (_HCL_valP) :
		(_HCL_reg_outputA));
    ...
    ulong _HCL_p_pc = (((_HCL_icode)==(8)) ? (_HCL_valC) :
		((_HCL_icode)==(9)) ? (_HCL_mem_output) :
		(_HCL_valP));
    ...
    ulong _HCL_reg_inputE = (((_HCL_icode)==(2)) ? (_HCL_reg_outputA) :
		...
		((_HCL_icode)==(5)) ? (_HCL_mem_output) :
		((((((_HCL_icode)==(10)))||(((_HCL_icode)==(11))))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (_HCL_valE) :
		(0UL));
    _HCL_reg_inputE &= 0xffffffffffffffff;
    if (showall) writefln("set reg_inputE to 0x%x",_HCL_reg_inputE);
    ulong _HCL_reg_inputM = ((((_HCL_icode)==(11))) ? (_HCL_mem_output) :
		(0UL));
...
pragma(msg,`Estimated clock delay: 135`);
enum tpt = 135;
