...
ulong _HCL_W_valC = 0;
ulong _HCL_W_reg_dstE = 15;
ulong _HCL_W_reg_outputA = 0;
...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_dstE = _HCL_W_reg_dstE;
    _HCL_reg_dstE &= 0xf;
    ...
    ulong _HCL_reg_inputE = (((_HCL_W_icode)==(2)) ? (_HCL_W_reg_outputA) :
		(((_HCL_W_icode)==(3))) ? (_HCL_W_valC) :
		0);
    ...
    ulong _HCL_d_icode = cast(ulong)(((_HCL_i10bytes)>>4UL)&0xf);
    _HCL_d_icode &= 0xf;
    ...
    ulong _HCL_d_valC = ((((_HCL_d_icode)==(7))) ? (cast(ulong)(((_HCL_i10bytes)>>8UL)&0xffffffffffffffff)) :
    ...
    ulong _HCL_offset = ((((((_HCL_d_icode)==(0)))||(((_HCL_d_icode)==(1))))||(((_HCL_d_icode)==(9)))) ? (1UL) :
		((((((_HCL_d_icode)==(2)))||(((_HCL_d_icode)==(6))))||(((_HCL_d_icode)==(10))))||(((_HCL_d_icode)==(11)))) ? (2UL) :
		((((_HCL_d_icode)==(7)))||(((_HCL_d_icode)==(8)))) ? (9UL) :
		(10UL));
    ...
    ulong _HCL_d_Stat = (((_HCL_d_icode)==(0)) ? (2) :
		((_HCL_d_icode)>(0xbUL)) ? (4) :
		(1));
    _HCL_d_Stat &= 0x7;
    if (showall) writefln("set d_Stat to 0x%x",_HCL_d_Stat);
    _HCL_stall_F = cast(bool)((((((_HCL_d_Stat)==(2)))||(((_HCL_d_Stat)==(4)))) ? (1UL) :
		(0UL)));
    if (showall) writefln("set stall_F to %s",_HCL_stall_F);
    ulong _HCL_reg_srcA = ((((_HCL_d_icode)==(2))) ? (_HCL_rA) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_d_reg_dstE = (((((_HCL_d_icode)==(3)))||(((_HCL_d_icode)==(2)))) ? (_HCL_rB) :
		(15));
    _HCL_d_reg_dstE &= 0xf;
    if (showall) writefln("set d_reg_dstE to 0x%x",_HCL_d_reg_dstE);
    ...
    ulong _HCL_d_reg_outputA = ((((_HCL_reg_dstE)!=(15))&&((_HCL_reg_dstE)==(_HCL_reg_srcA))) ? (_HCL_reg_inputE) :
		(_HCL_reg_outputA));
    _HCL_d_reg_outputA &= 0xffffffffffffffff;
    if (showall) writefln("set d_reg_outputA to 0x%x",_HCL_d_reg_outputA);
    ...
    else if (!_HCL_stall_W) _HCL_W_Stat = _HCL_d_Stat;
    if (_HCL_bubble_W) _HCL_W_icode = 1;
    else if (!_HCL_stall_W) _HCL_W_icode = _HCL_d_icode;
    if (_HCL_bubble_W) _HCL_W_valC = 0;
    else if (!_HCL_stall_W) _HCL_W_valC = _HCL_d_valC;
    if (_HCL_bubble_W) _HCL_W_reg_dstE = 15;
    else if (!_HCL_stall_W) _HCL_W_reg_dstE = _HCL_d_reg_dstE;
    if (_HCL_bubble_W) _HCL_W_reg_outputA = 0;
    else if (!_HCL_stall_W) _HCL_W_reg_outputA = _HCL_d_reg_outputA;
...
int main(string[] args) {
	...
	write(`| register dW(`,(_HCL_bubble_W?'B':_HCL_stall_W?'S':'N'));
		writefln(`) { Stat=%01x icode=%01x reg_dstE=%01x                            |`, _HCL_W_Stat, _HCL_W_icode, _HCL_W_reg_dstE);
		writefln(`|  reg_outputA=%016x valC=%016x }                 |`, _HCL_W_reg_outputA, _HCL_W_valC);
