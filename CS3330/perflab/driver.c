...
static int test_dim_rotate[] = {128, 256, 576, 1024, 1088, 2112};
static int test_dim_smooth[] = {32, 64, 128, 256, 576, 800};

/* Baseline CPEs (see config.h) */
static double rotate_baseline_cpes[] = {R128, R256, R576, R1024, R1088, R2112};
...
int main(int argc, char *argv[])
{
	...
	printf("  Smooth: %3.1f (%s)\n", smooth_maxmean, smooth_maxmean_desc);
        ...
        printf("cycles per element measured on your machine to a hard-coded\n");
        printf("baseline measured on our reference machine.\n");
    }
